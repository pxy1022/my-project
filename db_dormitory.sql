...
INSERT INTO `adjust_room` VALUES (8, 'stu6', '泡泡', 1102, 2, 1104, 4, '通过', '2022-03-19 23:06:52', '2024-06-21 08:19:02');
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('admin', '123456', '黎大', '男', 18, '14785412478', '5415348431@qq.com', '83de39763a5d4a21b1ddfe5eb5c7504c.jpg');
...
-- ----------------------------
INSERT INTO `dorm_build` VALUES (1, '13号楼', '男宿舍', 1);
INSERT INTO `dorm_build` VALUES (2, '8号楼', '女宿舍', 2);
INSERT INTO `dorm_build` VALUES (3, '14号楼', '男宿舍', 3);
INSERT INTO `dorm_build` VALUES (4, '9号楼', '女宿舍', 4);
...
-- ----------------------------
INSERT INTO `dorm_manager` VALUES ('dorm1', '123456', 1, '张三', '男', 35, '15995917873', NULL, 'd138e8bfe2f14871820ffbf13167330d.jpg');
...
INSERT INTO `dorm_room` VALUES (1102, 1, 1, 4, 3, 'stu5', NULL, 'stu7', 'stu1');
INSERT INTO `dorm_room` VALUES (1103, 1, 1, 4, 4, 'stu8', 'stu9', 'stu10', 'stu11');
INSERT INTO `dorm_room` VALUES (1104, 1, 1, 4, 1, NULL, NULL, NULL, 'stu6');
INSERT INTO `dorm_room` VALUES (1105, 1, 1, 4, 1, NULL, 'stu30', NULL, NULL);
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES (18, '欢迎各位使用', '<p>欢迎各位使用</p>', '大强', '2024-01-01 19:06:51');
INSERT INTO `notice` VALUES (19, '欢迎各位同学进入新宿舍', '<p>欢迎各位同学进入新宿舍! 大家根据自己需要选择合适的房位。</p>', '大强', '2024-01-01 19:12:57');
INSERT INTO `notice` VALUES (20, '需要保修设备的同学联系宿管！', '<p>需要保修设备的同学联系宿管！</p>', '大强', '2024-01-01 19:15:39');
INSERT INTO `notice` VALUES (21, '关于放假通知', '<p>元旦起，1.1~1.3放假三天。请同学们合理安排时间。</p>', '大强', '2024-01-04 19:16:26');

-- ----------------------------
-- Table structure for queqin
-- ----------------------------
...
CREATE TABLE `queqin`  (
  ...
  `fangjian_id` int(0) NULL DEFAULT NULL COMMENT '房间id',
  `content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '情况说明',
  `release_time` datetime(0) NULL DEFAULT NULL COMMENT '缺勤时间',
  `loucheng_id` int(0) NULL DEFAULT NULL COMMENT '宿舍楼号',
  `lou_id` int(0) NULL DEFAULT NULL COMMENT '楼层号',
  `chuangwei` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '床位',
  `sid` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '上报人id',
  `sname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '上报人',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of queqin
-- ----------------------------
INSERT INTO `queqin` VALUES (4, 'stu11', '巧巧', 1103, '<p>测试22222222</p>', '2025-01-09 00:00:00', 1, 1, '四号床位', '1234567', '测试');
INSERT INTO `queqin` VALUES (7, 'stu12', '丽丽', 2101, '<p>21111111</p>', '2025-01-21 00:00:00', 1, 2, '三号床位', '1234567', '测试');
INSERT INTO `queqin` VALUES (8, 'stu11', '巧巧', 1103, '<p>222222222222222222222222222</p>', '2025-01-30 00:00:00', 1, 1, '四号床位', 'admin', '大强');
INSERT INTO `queqin` VALUES (9, 'stu1', '张三', 1102, '<p>222222</p>', '2025-01-31 00:00:00', 1, 1, '四号床位', '1234567', '测试');
INSERT INTO `queqin` VALUES (10, 'stu10', '马克', 1103, '<p>c222222222222</p>', '2025-01-02 17:20:06', 1, 1, '四号床位', 'dorm1', '张三');
INSERT INTO `queqin` VALUES (11, 'stu1', '张三', 1102, '<p>222222222222222</p>', '2025-01-02 17:25:36', 1, 1, '四号床位', 'admin', '黎大');
...
-- Records of repair
-- ----------------------------
INSERT INTO `repair` VALUES (-1835335678, '张三', 1, 1102, '灯坏了', '1', '未完成', '2024-06-12 00:00:00', NULL);
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('stu1', '123456', 18, '张三', '男', '15875696512', NULL, 'f680aa9d34e44a47813243a8688f975e.jpg');
INSERT INTO `student` VALUES ('stu10', '123456', 20, '马克', '女', '15889635874', NULL, NULL);
...
INSERT INTO `student` VALUES ('stu30', '123456', 18, '牡丹', '男', '18565495842', NULL, NULL);
...
CREATE TABLE `fee`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `fee_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '费用类型',
  `dormbuild_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '楼宇号',
  `dormroom_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '房间号',
  `amount` decimal(10,2) NOT NULL COMMENT '费用金额',
  `payment_status` enum('已缴费','未缴费') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '未缴费' COMMENT '缴费状态',
  `payment_time` datetime(0) NULL DEFAULT NULL COMMENT '缴费时间',
...
-- Records of fee
-- ----------------------------
INSERT INTO `fee` VALUES (1, '水电费', '1', '1101', 150.00, '已缴费', '2024-01-15 10:30:00', '1月份水电费');
INSERT INTO `fee` VALUES (2, '网费', '1', '1102', 50.00, '未缴费', NULL, '1月份网费');
INSERT INTO `fee` VALUES (3, '物业费', '2', '2101', 200.00, '已缴费', '2024-01-20 14:20:00', '1月份物业费');
